...
export default defineConfig({
	resolve: {
		alias: [
			...
			{ find: /^@valkyriweb\/pi-telemetry$/, replacement: workspaceSourcePaths.telemetryIndex },
			{ find: /^@valkyriweb\/pi-telemetry\/testing$/, replacement: workspaceSourcePaths.telemetryTesting },
			{ find: /^@valkyriweb\/pi-ai$/, replacement: workspaceSourcePaths.aiIndex },
			{ find: /^@valkyriweb\/pi-ai\/compat$/, replacement: workspaceSourcePaths.aiCompat },
			{ find: /^@valkyriweb\/pi-ai\/oauth$/, replacement: workspaceSourcePaths.aiOAuth },
			{
				find: /^@valkyriweb\/pi-ai\/providers\/(.+)$/,
				replacement: `${workspaceSourcePaths.aiProviders}/$1.ts`,
			},
			{ find: /^@valkyriweb\/pi-agent-core$/, replacement: workspaceSourcePaths.agentIndex },
			{ find: /^@valkyriweb\/pi-tui$/, replacement: workspaceSourcePaths.tuiIndex },
