...
export default defineConfig({
	resolve: {
		alias: [
			...
			{ find: /^@lue-labs\/pi-telemetry$/, replacement: workspaceSourcePaths.telemetryIndex },
			{ find: /^@lue-labs\/pi-telemetry\/testing$/, replacement: workspaceSourcePaths.telemetryTesting },
			{ find: /^@lue-labs\/pi-ai$/, replacement: workspaceSourcePaths.aiIndex },
			{ find: /^@lue-labs\/pi-ai\/compat$/, replacement: workspaceSourcePaths.aiCompat },
			{ find: /^@lue-labs\/pi-ai\/oauth$/, replacement: workspaceSourcePaths.aiOAuth },
			{
				find: /^@lue-labs\/pi-ai\/providers\/(.+)$/,
				replacement: `${workspaceSourcePaths.aiProviders}/$1.ts`,
			},
			{ find: /^@lue-labs\/pi-agent-core$/, replacement: workspaceSourcePaths.agentIndex },
			{ find: /^@lue-labs\/pi-tui$/, replacement: workspaceSourcePaths.tuiIndex },
