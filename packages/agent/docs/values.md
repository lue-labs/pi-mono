...
`AssistantMessageFrame`, `AssistantMessageFrameEncoder`, and `reduceAssistantMessageFrames()` come from `@lue-labs/pi-ai`. Do not define a second frame codec or reducer.
