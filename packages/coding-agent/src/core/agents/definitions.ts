...
Include validation for the combined result and identify uncovered gaps.`,
	},
	{
		id: "plan",
		description:
			"Read-only planning profile for implementation strategy, integration points, risks, and validation. Runs without project instructions, append-system context, or preloaded skills, so the Agent task must supply relevant constraints and paths.",
		tools: ["read", "grep", "Glob"],
		denyTools: ["agent", "edit", "write", "bash"],
		model: "inherit",
		thinking: "inherit",
