...
export default defineConfig({
	...
	resolve: {
		alias: [
			...
			{ find: /^@valkyriweb\/pi-ai\/base$/, replacement: aiSrcBase },
			{ find: /^@valkyriweb\/pi-ai\/oauth$/, replacement: aiSrcOAuth },
			{ find: /^@valkyriweb\/pi-ai\/openrouter-images$/, replacement: aiOpenRouterImages },
			{ find: /^@valkyriweb\/pi-agent-core$/, replacement: agentSrcIndex },
			{ find: /^@valkyriweb\/pi-agent-core\/base$/, replacement: agentSrcBase },
			{ find: /^@valkyriweb\/pi-tui$/, replacement: tuiSrcIndex },
