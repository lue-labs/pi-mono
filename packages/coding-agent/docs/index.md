...
```bash
npm uninstall -g @lue-labs/pi-coding-agent
```

For pnpm, Yarn, or Bun installs, use the matching global remove command: `pnpm remove -g @lue-labs/pi-coding-agent`, `yarn global remove @lue-labs/pi-coding-agent`, or `bun uninstall -g @lue-labs/pi-coding-agent`.
