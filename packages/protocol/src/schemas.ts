...
export const ToolReferenceContentSchema = StrictObject({
...
export const ToolContentSchema = Type.Union([TextContentSchema, ImageContentSchema, ToolReferenceContentSchema]);
...
export type ToolReferenceContent = Static<typeof ToolReferenceContentSchema>;
