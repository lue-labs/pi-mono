...
try {
	...
	const baseBuild = await build({
		stdin: {
			contents: `import { complete } from "@valkyriweb/pi-ai/base";\nimport { Agent } from "@valkyriweb/pi-agent-core/base";\nconsole.log(typeof complete, typeof Agent);\n`,
	...
	await build({
		stdin: {
			contents: `import { register as registerAnthropic } from "@valkyriweb/pi-ai/anthropic";\nimport { register as registerOpenAICompletions } from "@valkyriweb/pi-ai/openai-completions";\nimport { register as registerOpenRouterImages } from "@valkyriweb/pi-ai/openrouter-images";\nconsole.log(typeof registerAnthropic, typeof registerOpenAICompletions, typeof registerOpenRouterImages);\n`,
			resolveDir: process.cwd(),
